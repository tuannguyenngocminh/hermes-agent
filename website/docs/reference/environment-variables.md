...
| `HERMES_DESKTOP_DEV_SERVER` | Vite dev-server URL the Electron shell loads instead of the packaged bundle (e.g. `http://127.0.0.1:5175`). Set automatically by `npm run dev`; only relevant when hacking on the app. |
