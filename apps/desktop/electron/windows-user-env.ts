...
// desktop's SUPER_AGENT_HOME resolution relies on process.env, so that stale-snapshot
// gap silently sends the backend to the default %LOCALAPPDATA%\super-agent. Reading
...
//       SUPER_AGENT_HOME    REG_SZ    F:\SuperAgent\data
//
